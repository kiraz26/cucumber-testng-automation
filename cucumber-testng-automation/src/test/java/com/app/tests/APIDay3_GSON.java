...
public class APIDay3_GSON {
	// GSON -> is a json parser. that is used to convert from java object to json
	// and from json to java object.
	// JSON -> JAVA OBJECT
	// DE-SERIALIZATION: Convert to JSON -> JAVA Object
	// SERIALIZATION: Convert to JAVA Object -> JSON
